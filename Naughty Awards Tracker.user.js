...
(function () {
    ...
    function initializeDashboard() {
        ...
        dashboard.innerHTML = "<style>" +
            ...
            "#nat-body{display:flex!important;padding:12px;background:linear-gradient(180deg,rgba(15,22,34,.45),rgba(10,15,24,.18));scrollbar-width:none;-ms-overflow-style:none}#nat-wrapper[data-theme='light'] #nat-body{background:rgba(227,237,248,.35)}#nat-content{gap:10px;width:calc(100% / var(--nat-scale,1));align-content:start}.nat-list{padding:0;width:100%;scrollbar-width:none;-ms-overflow-style:none}.nat-list::-webkit-scrollbar{display:none}" +
